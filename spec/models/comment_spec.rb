...
RSpec.describe Comment, type: :model do
  it 'Makes sure when you add a comment it increases the counter' do
    ...
    post = Post.create(author:, title: 'The rightful heir', text: 'My father!')
    subject = Comment.new(post:, user: author, text: 'My story')
  ...
  it "Can access the author's name" do
    author = User.create(name: 'Rhaenyra', photo: 'url', bio: 'Queen')
    post = Post.create(author:, title: 'The rightful heir', text: 'My father!')
    subject = Comment.create(post:, user: author, text: 'My story')
